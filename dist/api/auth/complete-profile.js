...
async function completeProfileHandler(req, res) {
    try {
        const { userId, email, name, contactNumber, city, country, userType, institution, highestEducation, odrLabUsage } = req.body;
        ...
        const updatedUser = await prisma_1.default.user.update({
            ...
            data: {
                ...
                city,
                country,
                userRole: userRole || "INNOVATOR", // Default to INNOVATOR if not provided
